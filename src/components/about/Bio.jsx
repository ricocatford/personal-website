        ...
        <div className="flex justify-between bio__container">
            ...
            <div className="bio__text__wrapper">
                <p className="bio__text">
                    ...
                    me Rico. Currently based in London, I was born in Argentina.
                    Technology has always been a part of my life, starting from
                    my early days as a kid when I got my hands on my first PC
                    with Windows 98. By the age of ten, I had already learned
                    how to format the computer using the command line. When my
                    family moved to Spain during my teenage years, I ventured
                    into website development using tools like Adobe Dreamweaver,
                    Flash, and Photoshop. As part of a big family, we had to be
                    resourceful, so my father and brothers would collect parts
                    from various computers to build new setups or upgrade
                    existing ones.
                </p>
                <p className="bio__text">
                ...
                <p className="bio__text">
                    ...
                    friends are also important to me, and I cherish the moments
                    I spend with them. I have a competitive streak when it comes
                    to gaming, particularly in FPS and MMO genres. Additionally,
                    I enjoy watching movies and exploring topics like psychology
                    and astronomy through books and videos.
                </p>
            </div>
        </div>
    );
