            ...
            <div className="hero__container flex">
                <div className="hero__wrapper flex">
                    ...
                    <p className="hero__text">
                        Currently based in London, UK. I was born in Argentina
                        and grew up in Spain. I've just finished my diploma in
                        Full-Stack Web Development at City of Bristol College.
                        I'm passionate about pixel-perfect designs!
                    </p>
